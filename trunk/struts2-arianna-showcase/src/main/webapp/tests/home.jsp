...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/breadcrumb/res/css/layout.css" media="screen" />
	
	<!-- 
	<script type="text/javascript" src="/breadcrumb/res/js/shCore.js"></script>
	<script type="text/javascript" src="/breadcrumb/res/js/shBrushXml.js"></script>
	<script type="text/javascript" src="/breadcrumb/res/js/shBrushJava.js"></script>
	 -->
